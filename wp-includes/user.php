...
function wp_insert_user( $userdata ) {
	...
	if ( ( ! $update || ( ! empty( $old_user_data ) && 0 !== strcasecmp( $user_email, $old_user_data->user_email ) ) )
		...
		// return new WP_Error( 'existing_user_email', __( 'Sorry, that email address is already used!' ) );
		 return new WP_Error( 'existing_user_email', __( 'Sorry, that email address is already used!', 'ndp' ) );
...
If you did not change your password, please contact the Site Administrator at UANDP
...
If you did not change your email, please contact UANDP administration
