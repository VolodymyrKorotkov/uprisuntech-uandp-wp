    ...
    <div class='row'>
      <div class='col-md-4'>
        <div class='contacts-page-left'>
          ...
          <h1 class='contacts-page-title'>Контакти</h1>
          <div class='contacts-page-item'>
            ...
            <div class='contacts-page-item-content'>
              <div class='contacts-page-item-content-text1'>Офіс</div>
              <div class='contacts-page-item-content-text2'>Асоціація декарбонізації “КОГЕН УКРАЇНА“</div>
              <div class='contacts-page-item-content-text3'><span class="js-contact-map">01021, м.Київ, вул.Інститутська, 22/7 <br> </span></div>
            </div>
          </div>
          <div class='contacts-page-item'>
            <div class='contacts-page-item-icon'>
            ...
            <div class='contacts-page-item-content'>
              <div class='contacts-page-item-content-text1'>Телефон</div>
              <div class='contacts-page-item-content-text2'>Пн-Пт з 9:00 - 17:30</div>
                <?php
...
<!-- <div class='contacts-departments'>
  <div class='container'>
    <div class='row'>
      <div class='col-md-3'>
        <div class='contacts-departments-title'>Відділи</div>
      </div>
    </div>
    <div class='row'>
      <div class='col-md-3'>
        <div class='contacts-departments-item'>
          <div class='contacts-departments-item-title'>Менеджмент</div>
          <div class='contacts-departments-item-text'>Сергій Довженко</div>
          <div class='contacts-departments-item-text2'>Начальник відділу</div>
      ...
      <div class='col-md-3'>
        <div class='contacts-departments-item'>
          <div class='contacts-departments-item-title'>Експерти</div>
          <div class='contacts-departments-item-text'>Ярослава Сміт</div>
          <div class='contacts-departments-item-text2'>Начальник відділу</div>
          <a href="tel:+38 (044) 000-00-00" class='contacts-departments-item-phone'>+38 (044) 000-00-00</a>
      ...
      <div class='col-md-3'>
        <div class='contacts-departments-item'>
          <div class='contacts-departments-item-title'>Керівники</div>
          <div class='contacts-departments-item-text'>Андрій Чорний</div>
          <div class='contacts-departments-item-text2'>Начальник відділу</div>
          <a href="tel:+38 (044) 000-00-00" class='contacts-departments-item-phone'>+38 (044) 000-00-00</a>
      ...
      <div class='col-md-3'>
        <div class='contacts-departments-item'>
          <div class='contacts-departments-item-title'>Підтримка</div>
          <div class='contacts-departments-item-text'>Олександр Біленков</div>
          <div class='contacts-departments-item-text2'>Начальник відділу</div>
          <a href="tel:+38 (044) 000-00-00" class='contacts-departments-item-phone'>+38 (044) 000-00-00</a>
      ...
      <div class='col-md-12'>
        <div class='contacts-form-container'>
          <div class='contacts-form-container-block'>
            <div class='row'>
              <div class='col-md-12'>
                <div class='contacts-form-title'>Зв'яжіться з нами</div>
                <div class='contacts-form-text'>Ми будемо раді зв’язатися з вами. Будь ласка, заповніть цю форму</div>
              </div>
            </div>
...
<div class="modal modal-map">
    ...
    <div class="modal__block">
        ...
        <div class="modal__body">
            <div class="acf-map">
                <div class="marker" data-lat="50.4452273" data-lng="30.5346742"></div>
            </div>
        </div>
    </div>
...
function showMessage(message) {
    ...
    if (popupContent) {
        ...
        firstParagraph.textContent = 'Ваше повідомлення було відправлене';
        ...
        secondParagraph.textContent = 'Наш експерт зв\'яжеться з вами найближчим часом';
