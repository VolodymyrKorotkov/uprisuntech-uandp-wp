 ...
 */
if ( apply_filters( 'llms_display_free_enroll_form', $plan->has_free_checkout() && $plan->is_available_to_user(), $plan ) ) :
	?>
	<?php llms_get_template( 'product/free-enroll-form.php', compact( 'plan' ) ); ?>
<?php else : ?>
	<a class="llms-button-action button btn btn_bg_primary course__card-button" href="<?php echo $plan->get_checkout_url(); ?>"><?php _e('Buy Course', 'ndp'); ?></a>
<?php endif; ?>
