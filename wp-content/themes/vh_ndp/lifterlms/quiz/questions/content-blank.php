<?php
/**
 * Blank Answer Question Template
 *
...
<div class="llms-aq-blank-wrapper mdc-text-field mdc-text-field--outlined">
    <input class="llms-aq-blank llms-aq-blank-field mdc-text-field__input" id="llms-question-answer-<?php echo $question->get( 'id' ); ?>" type="text">
