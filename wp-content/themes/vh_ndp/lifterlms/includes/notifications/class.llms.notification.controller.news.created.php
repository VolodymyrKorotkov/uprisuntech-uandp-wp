<?php
/**
 * Notification Controller: News created
 *
 ...
 */
class LLMS_Notification_Controller_News_Created extends LLMS_Abstract_Notification_Controller {
	 ...
	 * @var  array
	 */
	protected $action_hooks = array( 'lifterlms_news_created' );
...
return LLMS_Notification_Controller_News_Created::instance();
