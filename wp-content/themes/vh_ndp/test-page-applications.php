<?php
/*
Template Name: LMS Applications
...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/lms-applications.css">
...
<section class="account">
  <div class="container">
    ...
    <tr>
        <td class="applications__table-title applications__table-hidden-mobile">Application</td>
        <td class="applications__table-title applications__table-hidden-desktop">App.</td>
        <td class="applications__table-title">Status</td>
        <td class="applications__table-title">Amount</td>
        <td class="applications__table-title applications__table-title-last">Action</td>
    </tr>
    <tr>
        <td class="applications__table-number">№312</td>
        <td>Draft</td>
        <td class="applications__table-empty">Amount N/A</td>
        <td class="applications__table-image" style="text-align: center;">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/arrow-right.svg" alt="arrow-right" class="applications__table-hidden-mobile">
        </td>
    </tr>
    <tr>
        <td class="applications__table-number">№431</td>
        <td>Submitted</td>
        <td>$15,000.00</td>
        <td class="applications__table-image" style="text-align: center;">
             <!-- <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/notifications.svg" alt="notifications-icon"> -->
    ...
    <tr>
        <td class="applications__table-number">№5</td>
        <td>Not approved</td>
        <td>$12,000.00</td>
        <td class="applications__table-image" style="text-align: center;">         
             <!-- <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/notifications.svg" alt="notifications-icon"> -->
    ...
    <tr>
        <td class="applications__table-number">№110</td>
        <td>Approved</td>
        <td>$8 200,00</td>
        <td class="applications__table-image" style="text-align: center;">         
             <!-- <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/notifications.svg" alt="notifications-icon"> -->
...
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/lms-applications.js"></script>
