...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/dashboard-menu.css">
      ...
      <div class="account__content col-8">
        ...
        <div class="profile-settings__block profile-settings__personalData">
          ...
          <div class="profile-settings__personalData-wrapper col-3">
            ...
            <ul class="profile-settings__personalData-list">
              <li class="profile-settings__personalData-list__item profile-settings__personalData-list__item-current">UA (+38)</li>
        ...
        <div class="profile-settings__block profile-settings__contacts">
          ...
          <div class="profile-settings__contacts-item">
            ...
            <button class="profile-settings__contacts-button" id="edit-email">Edit</button>
          </div>
          <div class="profile-settings__contacts-item">
...
<div class="profile-settings__modal" id="modal__logout">
  <div class="profile-settings__modal-item">
    ...
    <h2 class="profile-settings__modal-title">Log out of the account</h2>
    <span class="profile-settings__modal-subtitle">Are you sure you want to log out of your account?</span>
    <div class="profile-settings__modal-buttons">
      <button class="profile-settings__modal-cancel">Cancel</button>
      <button class="profile-settings__modal-confirm">Logout</button>
    </div>
  </div>
</div>
<div class="profile-settings__modal" id="modal__emailChange">
    <div class="profile-settings__modal-item">
    <button class="profile-settings__modal-close"></button>
    <h2 class="profile-settings__modal-title">Email change</h2>
    <span class="profile-settings__modal-subtitle">Enter your new email and we will contact you to clarify details</span>
    ...
    <div class="profile-settings__modal-buttons">
      <button class="profile-settings__modal-cancel">Cancel</button>
      <button class="profile-settings__modal-confirm">Send</button>
    </div>
  </div>
  <!-- <div class="profile-settings__modal-item">
    <button class="profile-settings__modal-close"></button>
    <h2 class="profile-settings__modal-title">Request has been sent</h2>
    <span class="profile-settings__modal-subtitle">We will contact you to clarify information</span>
    <div class="profile-settings__modal-buttons">
      <button class="profile-settings__modal-confirm">Okay</button>
    </div>
  </div> -->
</div>
<div class="account__nav-mobile__overlay">
<nav class="account__nav-mobile">
        <a href="#" class="account__nav-mobile__item">
         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          <mask id="mask0_3459_11711" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
          <rect width="24" height="24" fill="#D9D9D9"/>
          </mask>
        ...
        <a href="#" class="account__nav-mobile__item">
         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <div class="account__nav-mobile__logout">
           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <mask id="mask0_3627_20052" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
            <rect width="24" height="24" fill="#D9D9D9"/>
            </mask>
            <g mask="url(#mask0_3627_20052)">
            <path d="M5 21C4.45 21 3.97917 20.8042 3.5875 20.4125C3.19583 20.0208 3 19.55 3 19V5C3 4.45 3.19583 3.97917 3.5875 3.5875C3.97917 3.19583 4.45 3 5 3H12V5H5V19H12V21H5ZM16 17L14.625 15.55L17.175 13H9V11H17.175L14.625 8.45L16 7L21 12L16 17Z" fill="#8A90A5"/>
            </g>
            </svg>
            Logout
          </div>
...
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/dashboard-menu.js"></script>
