<?php
/*
Template Name: Training center UA
*/
            ...
            <div class='row'>
                <div class='col-md-6'>
                    <div class='training-page-training-left'>
                        ...
                        <h1 class='training-page-training-left-title'>Центр навчання</h1>
                        <p>Комплексна навчальна платформа надає користувачам поглиблені знання та практичні навички, необхідні для успішних ініціатив з енергоефективності. Відстежуйте та зберігайте свій прогрес, отримуйте персоналізовані сповіщення та доступ до рекомендованих курсів для індивідуального навчання. </p>
                        <div class="training-buttons">
                            <a href='/courses' class='btn btn_bg_primary'>Всі курси</a>
                          <?php if ($student && !empty($courses)): ?>
                            <a href='<?php echo llms_get_endpoint_url( 'view-courses', '', llms_get_page_url( 'myaccount' ) ); ?>' class='btn btn_bg_light training-btn__continue'>Продовжити навчання</a>
                          <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class='training-page-training-rigth'>
                        ...
                        <div class='training-page-training-rigth-bottom'>
                          ...
                          <div class='training-page-training-rigth-bottom-block'>
                            ...
                            <p>Ми постійно оновлюємо програми навчання та матеріали </p>
                          </div>
                        </div>
                    </div>
                </div>
            ...
            <div class='row'>
                <div class='col-md-4'>
                    <p class='about-us-title'>
                      Цілі навчання на 1-й рік роботи платформи
                    </p>
                </div>
                <div class='col-md-8'>
                    <p class='about-us-text2'>
                        Центр навчання - це місце, де ви можете отримати комплексне навчання та інструменти, необхідні для участі у важливих проєктах зі збереження навколишнього середовища та енергоефективності. Наша мета - підготовка кваліфікованих фахівців, здатних зробити внесок у стале майбутнє планети.<br /><br />
                        Курси організовані у взаємопов’язані модулі та містять різноманітні матеріали, такі як статті, відео та інтерактивні тести, щоб забезпечити комплексний процес навчання.
                    </p>
                </div>
            </div>
  ...
  <div class="wizard" id="wizard" data-lang="<?php echo $current_lang; ?>">
    <div class="container">
      <div id="wizard__block" class="wizard__block">
        <h2 class="wizard__title">Візард</h2>
        <p class="wizard__subtitle">Візард - інструмент навігації, що складається з багатьох етапів, на кожному з яких користувач може обрати один або декілька варіантів </p>
        <div class="wizard__options">
          <div class="wizard__options-item">
            <h3 class="wizard__options-title">Чим ти займаєшся ? </h3>
            <p class="wizard__nothing">Нічого не вибрано</p>
            ...
            <button class="wizard__options-button__select">Виберіть параметри</button>
            <button class="wizard__options-button__save hidden">Збережіть параметри</button>
          </div>
          <div class="wizard__options-item wizard__options-item__main">
            <h3 class="wizard__options-title">Що ти хочеш робити? </h3>
            ...
            <button class="wizard__options-button__select hidden">Виберіть параметри</button>
            <button class="wizard__options-button__save">Збережіть параметри</button>
          </div>
          <div class="wizard__options-item">
            <h3 class="wizard__options-title">У якій сфері?</h3>
            <p class="wizard__nothing">Нічого не вибрано</p>
            <ul class="wizard__options-list hidden">
                <?php if (!empty($questions)): ?>
                    <?php foreach ($questions as $question): ?>
        ...
        <a href="" class="wizard__button">Показати курси</a>
      </div>
    </div>
  </div>
        ...
        <div class='row'>
          ...
          <div class='col-md-7'>
            <div class='training-paths-ringht'>
              <div class='training-paths-ringht-title'>Програми навчання</div>
              <div class='training-paths-ringht-text'>Програми навчання складаються із ряду структурованих курсів та модулів, розроблених, щоб направляти користувачів на шляху до експертності у енергоефективності.<br /><br />
              Користувачі можуть обирати із різних напрямків навчання, підібраних за їх інтересами або професійними цілями, що полегшує здобуття знань і навичок, необхідних, щоб стати агентами позитивних змін на шляху до сталого майбутнього, або навіть частиною Платформи.
              </div>
              <div class='training-paths-ringht-text2'>Скоро</div>
              <div class='btn-disable'>До програм навчання</div>
            </div>
          </div>
        </div>
                        ...
                        <div class='row'>
                            <div class='col-md-6'>
                                <div class='subscribe-left'>
                                    ...
                                    <div class='subscribe-left-title'>Підпишіться на нові курси</div>
                                    <p>І дізнавайтесь першими про нові курси та тренінги на нашій платформі</p>
                                    <a href="/contacts/" class="btn btn_bg_primary"><img
                                                src='<?php bloginfo('template_url');?>/assets/img/training-center/mail.svg' /> Підпишіться зараз
                                    </a>
                                </div>
                            </div>
                            <div class='col-md-6'>
