...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/my-courses.css">
    ...
    <div class="account__block">
      ...
      <div class="account__content col-8">
        ...
        <div class="my-courses__item">
            <div class="my-courses__item-header">
              <div class="my-courses__item-header__left">
               <div class="my-courses__item-about">
                <span class="my-courses__item-category">Solar Solutions</span>
                <span class="my-courses__item-level">Level 1</span>
                <span class="my-courses__item-complexity">Beginner</span>
                <span class="my-courses__item-more">+2</span>
               </div>
               <h2>The complete SOLAR ENERGY course. Beginner to advanced level
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div class="my-courses__item-description">
            <p>
            ...
            <div class="my-courses__item-info">
              <div class="my-courses__item-provider">
                <span>Provider:</span><strong>Tesla, Inc.</strong>
              </div>
              <div class="my-courses__item-time">
        ...
        <div class="my-courses__item">
            <div class="my-courses__item-header">
              <div class="my-courses__item-header__left">
               <div class="my-courses__item-about">
                <span class="my-courses__item-category">Electricity</span>
                <span class="my-courses__item-level">Level 3</span>
                <span class="my-courses__item-complexity">Expert</span>
                <span class="my-courses__item-more">+2</span>
               </div>
            ...
            <div class="my-courses__item-status">
              ...
              <div class="my-courses__item-progress">
                <span class="my-courses__item-progress-current"></span>
              </div>
              <span class="my-courses__item-percent">25%</span>
            </div>
          </div>
        <div class="my-courses__item">
            <div class="my-courses__item-header">
              <div class="my-courses__item-header__left">
               <div class="my-courses__item-about">
                <span class="my-courses__item-category">Energy Efficiency</span>
                <span class="my-courses__item-level">Level 2</span>
                <span class="my-courses__item-complexity">Intermediate</span>
                <span class="my-courses__item-more">+2</span>
               </div>
               <h2>The complete 2022 PV solar energy | PVsyst, Excel & AutoCAD
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
               <mask id="mask0_3519_14015" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                 <rect width="24" height="24" fill="#D9D9D9"/>
               </mask>
            ...
            <div class="my-courses__item-status">
              <span class="my-courses__item-value">
                ...
                Finished</span>
                <span class="my-courses__item-state">Valid</span>
                <span class="my-courses__item-date">Until 06.09.2025</span>
            </div>
          </div>
        <div class="my-courses__item">
            <div class="my-courses__item-header">
              <div class="my-courses__item-header__left">
               <div class="my-courses__item-about">
                <span class="my-courses__item-category">Solar Panel Installation</span>
                <span class="my-courses__item-level">Level 1</span>
                <span class="my-courses__item-complexity">Beginner</span>
                <span class="my-courses__item-more">+2</span>
               </div>
               <h2>The ultimate OFF-GRID solar energy course. Become a Pro 2023
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
               <mask id="mask0_3519_14015" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                 <rect width="24" height="24" fill="#D9D9D9"/>
               </mask>
            ...
            <div class="my-courses__item-status">
              <span class="my-courses__item-value">
                ...
                Finished</span>
                <span class="my-courses__item-state my-courses__item-state__invalid">Invalid</span>
                <span class="my-courses__item-date">Until 06.09.2025</span>
            </div>
          </div>
        </div>
...
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/my-courses.js"></script>
