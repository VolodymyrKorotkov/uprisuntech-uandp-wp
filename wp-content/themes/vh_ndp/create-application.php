<?php
/*
Template Name: Create Application
*/

$isLoggedIn = is_user_logged_in();
if($isLoggedIn){
  $new_url = "/en/create-application-type";
...
<div class='create-aplication-page'>
  <div class='create-aplication-page-content'>
    <div class='create-aplication-page-content-text'>Create Application</div>
    <div class='create-aplication-page-content-title'>Do you have an account?</div>
    <div class='create-aplication-page-content-actions'>
      <a href='/en/create-application-type' class='create-aplication-page-content-actions-btn'>
        ...
        <div class='create-aplication-page-content-actions-btn-text'>Skip this step</div>
      </a>
      <a href='/en/dashboard' class='create-aplication-page-content-actions-btn'>
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
        ...
        <div class='create-aplication-page-content-actions-btn-text'>Create account</div>
      </a>
      <a href='/en/dashboard' class='create-aplication-page-content-actions-btn'>
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
        ...
        <div class='create-aplication-page-content-actions-btn-text'>Log in</div>
      </a>
    </div>
  </div>
</div>
