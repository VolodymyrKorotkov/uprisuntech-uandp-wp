...
.asp-ui.ui-widget input, .asp-ui.ui-widget select, .asp-ui.ui-widget textarea, .asp-ui.ui-widget button { font-family:
Verdana,Arial,sans-serif; font-size: 1em; }
...
border: 1px solid #E1E1E1; background: #F9F9F9; font-weight: normal; color: #555555; }
.asp-ui .ui-state-default a, .asp-ui .ui-state-default a:link, .asp-ui .ui-state-default a:visited { color: #555555;
text-decoration: none; }
.asp-ui .ui-state-hover, .asp-ui.ui-widget-content .ui-state-hover, .asp-ui .ui-widget-header .ui-state-hover, .asp-ui
.ui-state-focus, .asp-ui.ui-widget-content .ui-state-focus, .asp-ui .ui-widget-header .ui-state-focus { border: 1px
solid #999999; background: #dadada; font-weight: normal; color: #212121; }
...
border: 1px solid #aaaaaa; background: #ffffff; font-weight: normal; color: #212121; }
.asp-ui .ui-state-active a, .ui-state-active a:link, .asp-ui .ui-state-active a:visited { color: #212121;
text-decoration: none; }
.asp-ui .asp-ui.ui-widget :active { outline: none; }

/* Interaction Cues
----------------------------------*/
.asp-ui .ui-state-highlight, .asp-ui.ui-widget-content .ui-state-highlight, .asp-ui .ui-widget-header
.ui-state-highlight {border: 1px solid #1cb1f2; background: #5bc6f5; color: #ffffff; }
.asp-ui .ui-state-highlight a, .asp-ui.ui-widget-content .ui-state-highlight a,.asp-ui .ui-widget-header
.ui-state-highlight a { color: #ffffff; }
.asp-ui .ui-state-error, .asp-ui.ui-widget-content .ui-state-error, .asp-ui .ui-widget-header .ui-state-error {border:
...
color: #cd0a0a; }
.asp-ui .ui-state-error-text, .asp-ui.ui-widget-content .ui-state-error-text, .asp-ui .ui-widget-header
.ui-state-error-text { color: #cd0a0a; }
.asp-ui .ui-priority-primary, .asp-ui.ui-widget-content .ui-priority-primary, .asp-ui .ui-widget-header
.ui-priority-primary { font-weight: bold; }
.asp-ui .ui-priority-secondary, .asp-ui.ui-widget-content .ui-priority-secondary, .asp-ui .ui-widget-header
.ui-priority-secondary { opacity: .7; font-weight: normal; }
.asp-ui .ui-state-disabled, .asp-ui.ui-widget-content .ui-state-disabled, .asp-ui .ui-widget-header .ui-state-disabled {
opacity: .35; background-image: none; }
...
/* Corner radius */
.asp-ui.ui-corner-all, .ui-corner-top, .ui-corner-left, .ui-corner-tl { -moz-border-radius-topleft: 4px;
-webkit-border-top-left-radius: 4px; -khtml-border-top-left-radius: 4px; border-top-left-radius: 4px; }
.asp-ui.ui-corner-all, .ui-corner-top, .ui-corner-right, .ui-corner-tr { -moz-border-radius-topright: 4px;
-webkit-border-top-right-radius: 4px; -khtml-border-top-right-radius: 4px; border-top-right-radius: 4px; }
.asp-ui.ui-corner-all, .ui-corner-bottom, .ui-corner-left, .ui-corner-bl { -moz-border-radius-bottomleft: 4px;
-webkit-border-bottom-left-radius: 4px; -khtml-border-bottom-left-radius: 4px; border-bottom-left-radius: 4px; }
.asp-ui.ui-corner-all, .ui-corner-bottom, .ui-corner-right, .ui-corner-br { -moz-border-radius-bottomright: 4px;
-webkit-border-bottom-right-radius: 4px; -khtml-border-bottom-right-radius: 4px; border-bottom-right-radius: 4px; }

/* Overlays */
.ui-widget-overlay { background: #aaaaaa; opacity: .30; }
.ui-widget-shadow { margin: -8px 0 0 -8px; padding: 8px; background: #aaaaaa; opacity: .30; -moz-border-radius: 8px;
...
.asp-ui.ui-datepicker .ui-datepicker-prev, .asp-ui.ui-datepicker .ui-datepicker-next { position:absolute; top: 2px;
width: 1.8em; height: 1.8em; display: none; }
...
.asp-ui.ui-datepicker .ui-datepicker-prev span, .asp-ui.ui-datepicker .ui-datepicker-next span { display: block;
...
.asp-ui.ui-datepicker td span, .asp-ui.ui-datepicker td a { display: block; padding: .2em; text-align: right;
text-decoration: none; }
.asp-ui.ui-datepicker .ui-datepicker-buttonpane { background-image: none; margin: .7em 0 0 0; padding:0 .2em;
border-left: 0; border-right: 0; border-bottom: 0; }
.asp-ui.ui-datepicker .ui-datepicker-buttonpane button { float: right; margin: .5em .2em .4em; cursor: pointer; padding:
...
input[type=checkbox]:checked ~ .asp_option_cat {
background: blue;
}
