    ...
    let functions = {
        ...
        initSettingsEvents: function () {
            ...
            $('.asp_option_cat input[type="checkbox"], .asp_option_cff input[type="checkbox"]', $this.n('searchsettings')).on('asp_chbx_change', function () {
                ...
                console.log(className + '_section');

                let classSection = '.' + className + '_section';

                console.log(classSection);

                //$(classSection).removeClass("hiddend");

                if ($(classSection).hasClass("hiddend")) {
                    $(classSection).removeClass("hiddend");
                } else {
                    $(classSection).addClass("hiddend");
                }
