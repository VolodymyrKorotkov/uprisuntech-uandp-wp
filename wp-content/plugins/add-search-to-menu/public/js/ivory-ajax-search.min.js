    ...
    jQuery(document).ready(function ($) {
        ...
        $('body').on('mouseover', '.is-ajax-search-tags > div, .is-ajax-search-categories > div, .is-ajax-search-post.is-product', function (event) {
            ...
            if (parseInt(window_width) >= 910) {
                ...
                var result_box_max_height = $('.is-form-id-' + form_id).attr('data-result-box-max-height') || '680';
        ...
        $('.clear-search-request').on('click', function (event) {
            //alert('Clear form result!!!@#');
            $('.is-search-input').val('');
            //alert('Start new search');
            $('.is-search-input').trigger("keyup");
            $('.clear-search-request').hide();
            event.stopPropagation();
            event.preventDefault();
            return false;
        });
        ...
        function is_ajax_process_request(self, page) {
            ...
            var result_box_max_height = search_form.attr('data-result-box-max-height') || '680';
            ...
            if (1 === page) {
                ...
                search_form.addClass('clear-search');
            }
            ...
            if (search_term.length >= min_no_for_search) {
                ...
                if (1 === page) {
                    ...
                    search_form.find('.clear-search').show();
                }
                ...
                ajax = $.ajax({
                    ...
                    success: function (data) {
                        ...
                        //search_form.find('.clear-search').show();
                        //search_form.removeClass('clear-search');
                        ...
                        if (1 === page) {
                            ...
                            search_form.find('.clear-search-request').show();
                            //console.log('Show closing icon');
