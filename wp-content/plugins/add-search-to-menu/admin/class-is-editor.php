...
class IS_Search_Editor
{
        ...
        ?>">
            ...
            <div class="form-table form-table-panel-includes">
                ...
                <h3 scope="row">
                    ...
                    <span class="is-actions"><a class="expand" href="#">
                            <?php
                            esc_html_e('Expand All', 'add-search-to-menu');
                            ?>
                        </a><a class="collapse" href="#" style="display:none;">
                            <?php
        ...
        ?>">
            ...
            <div class="form-table form-table-panel-customize">
                ...
                ?>">
                    ...
                    if ('default-search-form' == $post->name() && !isset($is_ajax['enable_ajax'])) {
                        ?>
                        <span class="is-field-disabled-message"><span class="message">
                                <?php
    ...
    public function ajax_panel($post)
    {
        ...
        // Result Layout.
        $result_box_max_height = (isset($settings['result_box_max_height']) ? $settings['result_box_max_height'] : 680);
            ...
            <div class="form-table form-table-panel-ajax">
                ...
                <h3 scope="row">
                    ...
                    <span class="is-actions">
                        ...
                        <a class="collapse" href="#" style="display:none;">
                            <?php
                            esc_html_e('Collapse All', 'add-search-to-menu');
                            ?>
                        </a>
                ...
                foreach ($group as $prop => $val) {
                    ...
                    switch ($prop) {
                        case 'post_type':
                            ...
                            if (!empty($diff)) {
                                $conflicts[$prop] = sprintf(esc_html(
                                    _n(
