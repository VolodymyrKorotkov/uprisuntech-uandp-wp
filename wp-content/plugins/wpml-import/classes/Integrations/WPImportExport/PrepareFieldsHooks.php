...
class PrepareFieldsHooks implements \IWPML_Backend_Action, \IWPML_DIC_Action {
	...
	public function add_hooks() {
		Hooks::onFilter( 'wpie_pre_execute_post_query' )->then( spreadArgs( [ $this, 'includeAllLanguages' ] ) );
		Hooks::onFilter( 'wpie_pre_execute_taxonomy_query' )->then( spreadArgs( [ $this, 'includeAllLanguages' ] ) );
	 ...
	 * @return array
	 */
	public function includeAllLanguages( $queryArgs ) {
